...
# Load the video file
Video_path = r"C:\Users\pnaSu\Downloads\Untitled video - Made with Clipchamp (1).mp4"
    ...
    try:
        ...
        while True:
            ...
            if results.multi_face_landmarks: 
                ...
                cv.putText(
                    frame, f"Left Iris: {lefteye_iris_pos} {left_ratio:.2f}",
                    (30, 50), 
                ...
                cv.putText(
                    frame, f"Right Iris: {righteye_iris_pos} {right_ratio:.2f}",
                    (30, 75), 
                    cv.FONT_HERSHEY_PLAIN, 
                    2, 
                    (0,255,0), 
