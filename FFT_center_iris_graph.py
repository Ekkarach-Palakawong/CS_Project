...
mean_peakleftx = s.mean(peakleftx)
mean_peaklefty = s.mean(peaklefty)
mean_peakrightx = s.mean(peakrightx)
mean_peakrighty = s.mean(peakrighty)

mean_Npeakleftx = s.mean(Npeakleftx)
mean_Npeaklefty = s.mean(Npeaklefty)
mean_Npeakrightx = s.mean(Npeakrightx)
mean_Npeakrighty = s.mean(Npeakrighty)

std_peakleftx = s.stdev(peakleftx)
std_peaklefty = s.stdev(peaklefty)
std_peakrightx = s.stdev(peakrightx)
std_peakrighty = s.stdev(peakrighty)

std_Npeakleftx = s.stdev(Npeakleftx)
std_Npeaklefty = s.stdev(Npeaklefty)
std_Npeakrightx = s.stdev(Npeakrightx)
std_Npeakrighty = s.stdev(Npeakrighty)
...
CI_lx = stats.norm.interval(0.90, loc = mean_peakleftx, scale = temp1x)
lwb_lx ,upb_lx = CI_lx
CI_ly = stats.norm.interval(0.90, loc = mean_peaklefty, scale = temp1y)
lwb_ly ,upb_ly = CI_ly

CI_rx = stats.norm.interval(0.90, loc = mean_peakrightx, scale = temp2x)
lwb_rx ,upb_rx = CI_rx
CI_ry = stats.norm.interval(0.90, loc = mean_peakrighty, scale = temp2y)
lwb_ry ,upb_ry = CI_ry

N_CI_lx = stats.norm.interval(0.90, loc = mean_Npeakleftx, scale = temp3x)
N_lwb_lx ,N_upb_lx = N_CI_lx
N_CI_ly = stats.norm.interval(0.90, loc = mean_Npeaklefty, scale = temp3y)
N_lwb_ly ,N_upb_ly = N_CI_ly

N_CI_rx = stats.norm.interval(0.90, loc = mean_Npeakrightx, scale = temp4x)
N_lwb_rx ,N_upb_rx = N_CI_rx
N_CI_ry = stats.norm.interval(0.90, loc = mean_Npeakrighty, scale = temp4y)
